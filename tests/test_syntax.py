"""
    ...
    Tests for the :mod:`~pai.syntax` module.
"""
...
def fake_root_node(fake_root_node_input):
    """
    Fixture that yields the result of :func:`~pai.syntax.root` with fake values.
    """
...
def fake_child_node(fake_child_node_input, fake_root_node):
    """
    Fixture that yields the result of :func:`~pai.syntax.child` with fake values and a root node generated by the
    :func:`fake_root_node` fixture.
    """
    return syntax.child(*fake_child_node_input, fake_root_node)
...
def test_root_creates_root_node(fake_root_node):
    """
    Assert that :func:`~pai.syntax.root` creates a :class:`~pai.syntax.Node` instance whose
    :prop:`~pai.syntax.Node.is_root` returns `True`.
    """
...
def test_root_creates_node_with_no_links(fake_root_node):
    """
    Assert that :func:`~pai.syntax.root` creates a :class:`~pai.syntax.Node` instance with no child links.
    """
...
def test_child_creates_child_node(fake_child_node):
    """
    Assert that :func:`~pai.syntax.child` creates a :class:`~pai.syntax.Node` instance whose
    :prop:`~pai.syntax.Node.is_root` returns `False`.
    """
...
def test_child_creates_nodes_with_links(fake_child_node, fake_root_node):
    """
    Assert that :func:`~pai.syntax.child` creates a :class:`~pai.syntax.Node` instance with a parent link to the root
